...
class PhotoHashCache(context: Context) : SQLiteOpenHelper(
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        // This database is only a derived cache. Rebuilding is safer than mixing
        // hashes generated by different algorithm versions.
    ...
    companion object {
        private const val DATABASE_NAME = "lia_photo_hashes.db"
